...
export class Avatar<T extends AvatarProps> extends React.Component<T, {}> {
    protected onValidated(_: string): void {
    ...
    private onChange(e: React.ChangeEvent<HTMLInputElement>): void {
        ...
        fileReader.onload = () => {
            ...
            this.onValidated(`data:${file.type};base64,${base64}`);
        };
    ...
    render(): JSX.Element {
        return <div id={this.props.id} className='avatar-control'>
            ...
            <input onChange={this.onChange.bind(this)} type='file' accept="image/png,image/jpeg,image/gif"/>
        </div>
    }
}